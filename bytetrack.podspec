#
#  Be sure to run `pod spec lint Utrackerpod.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "bytetrack系统SDK"
  spec.homepage     = "https://github.com/byte-track"
  ...
  spec.author             = { "ByteLink" => "finn.skyer.summer@gmail.com" }
 ...
 # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  ...
  spec.source       = { :git => "https://github.com/byte-track/bytetrack-sdk-iOS", :tag => "#{spec.version}" }
  ...
  #
    ...
    #spec.resource  = "Utrackerpod.framework/BytesTrack.bundle"#资源相对于本文件本地路径 
